...
if organize == True:
    t.addCommand( "Filter/PxF_Bandpass", "nuke.createNode('PxF_Bandpass')", icon="PxF_Bandpass.png" ) 
    t.addCommand( "Deep/PxF_DeepResample", "nuke.createNode('PxF_DeepResample')", icon="PxF_DeepResample.png")
    v = t.addMenu("Filter/PxF_Defocus", icon="PxF_IDefocus.png")
    v.addCommand( "PxF_DeepDefocus", "nuke.createNode('PxF_DeepDefocus')", icon="PxF_IDefocus.png")
    v.addCommand( "PxF_IDefocus", "nuke.createNode('PxF_IDefocus')", icon="PxF_IDefocus.png")
    v.addCommand( "PxF_ZDefocus", "nuke.createNode('PxF_ZDefocus')", icon="PxF_IDefocus.png")
    t.addCommand( "Transform/PxF_Distort", "nuke.createNode('PxF_Distort')", icon="PxF_Distort.png") 
    t.addCommand( "Filter/PxF_Erode", "nuke.createNode('PxF_Erode')", icon="PxF_Erode.png")
    t.addCommand( "Draw/EDGE EXTENDS/PxF_Filler", "nuke.createNode('PxF_Filler')", icon="PxF_Filler.png") 
    t.addCommand( "Draw/GRAIN/PxF_Grain", "nuke.createNode('PxF_Grain')", icon="PxF_Grain.png") 
    t.addCommand( "Color/PxF_HueSat", "nuke.createNode('PxF_HueSat')", icon="PxF_HueSat.png")  
    t.addCommand( "Keyer/SPILL/PxF_KillSpill", "nuke.createNode('PxF_KillSpill')", icon="PxF_KillSpill.png")
    w = t.addMenu("3D/PxF_Lights", icon="PxF_Lights.png")
    w.addCommand( "PxF_AreaLight", "nuke.createNode('PxF_AreaLight')", icon="PxF_AreaLight.png" )
    w.addCommand( "PxF_EnvLight", "nuke.createNode('PxF_EnvLight')", icon="PxF_EnvLight.png" )
    w.addCommand( "PxF_GeoLight", "nuke.createNode('PxF_GeoLight')", icon="PxF_GeoLight.png" )
    w.addCommand( "PxF_RingLight", "nuke.createNode('PxF_RingLight')", icon="PxF_RingLight.png" )
    w.addCommand( "PxF_TubeLight", "nuke.createNode('PxF_TubeLight')", icon="PxF_TubeLight.png" )
    t.addCommand( "Draw/PxF_Line", "nuke.createNode('PxF_Line')", icon="PxF_Line.png" ) 
    t.addCommand( "Draw/PxF_MergeWrap", "nuke.createNode('PxF_MergeWrap')", icon="PxF_MergeWrap.png" ) 
    t.addCommand( "Keyer/PxF_ScreenClean", "nuke.createNode('PxF_ScreenClean')", icon="PxF_ScreenClean.png")
    t.addCommand( "3D/PxF_SmokeBox", "nuke.createNode('PxF_SmokeBox')", icon="PxF_SmokeBox.png")
    t.addCommand( "Filter/PxF_Smoother", "nuke.createNode('PxF_Smoother')", icon="PxF_Smoother.png")
    t.addCommand( "Time/PxF_TimeMerge", "nuke.createNode('PxF_TimeMerge')", icon="PxF_TimeMerge.png")
    t.addCommand( "Draw/EDGE EXTENDS/PxF_VectorEdgeBlur", "nuke.createNode('PxF_VectorEdgeBlur')", icon="PxF_VectorEdgeBlur.png")